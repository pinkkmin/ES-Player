    ...
    children: [
      {
        path: 'index',
        name: 'message',
        component: () => import('@/views/mymatch/index'),
        meta: { title: '赛事中心', icon: 'mymatch' }
      }]
  },
  {
    path: '/myteam',
    component: Layout,
    meta: { title: '我的主队', icon: 'myteam' },
    children: [
      {
        path: '/',
        name: 'myteam',
